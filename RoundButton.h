...
// Owner-draw button with rounded corners, customizable border, background, and mouse-over color.
...
private:
    void DrawRoundedRectangle(Graphics& g, Pen& pen, Brush& brush, RectF rect, float radius);
